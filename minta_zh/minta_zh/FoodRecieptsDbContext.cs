...
namespace minta_zh
{
    public class FoodRecieptsDbContext : DbContext
    {

        #region Itt definiálom a táblákat
        public virtual DbSet<Ingredient> Ingredients { get; set; }
        public virtual DbSet<Receipt> Receipts { get; set; }
        #endregion

        // Ez biztosítja azt, hogy a DB már felépült tudom piszkálni
        public FoodRecieptsDbContext()
        {
            Database.EnsureCreated();
        }

        // Ez a rész az InMemoryDB betöltése

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseInMemoryDatabase("FoodRecieptsDb");
        }

        //Lazy load, Táblakapcsolat
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Ingredient>(ingredient =>
                 ingredient.HasOne(x => x.Receipt)
